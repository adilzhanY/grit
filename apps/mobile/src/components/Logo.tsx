...
export function Logo({
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 509 509">
      {background ? <Rect width={509} height={509} rx={112} fill={background} /> : null}
